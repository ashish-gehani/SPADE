...
#ifndef SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_VFORK_HOOK_H
#define SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_VFORK_HOOK_H
...
#define KERNEL_FUNCTION_SYS_VFORK_BUILD_HOOK_CONTEXT() \
...
/*
    Get the sys_vfork function number.
*/
...
/*
    Get the sys_vfork hook.

    Returns:
        ptr     -> Pointer to KERNEL_FUNCTION_SYS_VFORK_HOOK.
        NULL    -> Not available.
*/
const struct kernel_function_hook* kernel_arch_common_overridable_function_sys_vfork_hook_get(void);

/*
    Validate sys_vfork pre-execution context.
...
*/
bool kernel_arch_common_function_sys_vfork_hook_context_pre_is_valid(
    const struct kernel_function_hook_context_pre *ctx
);

/*
    Validate sys_vfork post-execution context.
    ...
    Returns:
        ...
        false   -> Invalid context.
*/
bool kernel_arch_common_function_sys_vfork_hook_context_post_is_valid(
    const struct kernel_function_hook_context_post *ctx
);

#endif // SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_VFORK_HOOK_H
