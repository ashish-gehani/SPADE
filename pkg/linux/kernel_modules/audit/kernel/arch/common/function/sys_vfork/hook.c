...
enum kernel_function_number kernel_function_hook_function_vfork_num(void)
{
    return global_func_num;
}

void kernel_function_sys_vfork_hook_pre(const struct kernel_function_hook_context *h_ctx)
{
    int err;
...
void kernel_function_sys_vfork_hook_post(const struct kernel_function_hook_context *h_ctx, long sys_res)
{
    int err;
...
const struct kernel_function_hook* __weak kernel_function_sys_vfork_hook_get(void)
{
    return NULL;
}

bool kernel_function_sys_vfork_hook_context_pre_is_valid(const struct kernel_function_hook_context_pre *ctx)
{
    return (
...
bool kernel_function_sys_vfork_hook_context_post_is_valid(const struct kernel_function_hook_context_post *ctx)
{
    return (
