...
const struct kernel_function_hook* __weak kernel_function_sys_recvmsg_hook_get(void)
{
    return NULL;
}

bool kernel_function_sys_recvmsg_hook_context_pre_is_valid(const struct kernel_function_hook_context_pre *ctx)
{
    return (
...
bool kernel_function_sys_recvmsg_hook_context_post_is_valid(const struct kernel_function_hook_context_post *ctx)
{
    return (
