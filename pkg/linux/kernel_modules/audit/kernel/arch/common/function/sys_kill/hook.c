...
#include "audit/kernel/arch/common/function/sys_kill/result.h"
#include "audit/kernel/arch/common/function/sys_kill/ubsi.h"
...
/* Arch-specific implementations (e.g. audit/kernel/arch/x86_64/function/sys_kill/hook.c) provide
