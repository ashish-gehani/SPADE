...
static void _ensure_initialized(void)
{
    ...
    {
        KERNEL_FUNCTION_SYS_SENDTO_OP.hook = kernel_function_sys_sendto_hook_get();
        KERNEL_FUNCTION_SYS_SENDTO_OP.action_list = kernel_function_sys_sendto_action_list_get();
