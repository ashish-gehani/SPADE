...
#include "audit/kernel/arch/common/function/sys_sendmsg/action/audit.h"
...
int kernel_arch_common_function_sys_sendmsg_action_audit_handle_post(
    const struct kernel_function_hook_context_post *ctx_post
)
{
    const char *log_id = "kernel_arch_common_function_sys_sendmsg_action_audit_handle_post";
    int err;
    ...
    if (!kernel_arch_common_function_sys_sendmsg_hook_context_post_is_valid(ctx_post))
        return -EINVAL;
