...
static void _ensure_initialized(void)
{
    ...
    {
        KERNEL_FUNCTION_SYS_UNSHARE_OP.hook = kernel_arch_common_overridable_function_sys_unshare_hook_get();
        KERNEL_FUNCTION_SYS_UNSHARE_OP.action_list = kernel_arch_common_function_sys_unshare_action_list_get();
