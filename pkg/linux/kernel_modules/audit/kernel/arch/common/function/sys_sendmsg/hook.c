...
#include "audit/kernel/arch/common/function/sys_sendmsg/result.h"


static const enum kernel_function_number global_func_num = KERN_F_NUM_SYS_SENDMSG;
...
/* Arch-specific implementations (e.g. audit/kernel/arch/x86_64/function/sys_sendmsg/hook.c) provide
...
const struct kernel_function_hook* __weak kernel_arch_common_overridable_function_sys_sendmsg_hook_get(void)
{
    return NULL;
}

bool kernel_arch_common_function_sys_sendmsg_hook_context_pre_is_valid(const struct kernel_function_hook_context_pre *ctx)
{
    return (
...
bool kernel_arch_common_function_sys_sendmsg_hook_context_post_is_valid(const struct kernel_function_hook_context_post *ctx)
{
    return (
