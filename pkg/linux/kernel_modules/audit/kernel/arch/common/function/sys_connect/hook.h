...
#ifndef SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CONNECT_HOOK_H
#define SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CONNECT_HOOK_H
...
/*
    Get the sys_connect hook.

    Returns:
        ptr     -> Pointer to KERNEL_FUNCTION_SYS_CONNECT_HOOK.
        NULL    -> Not available.
*/
const struct kernel_function_hook* kernel_function_sys_connect_hook_get(void);

/*
    Validate sys_connect pre-execution context.
...
*/
bool kernel_function_sys_connect_hook_context_pre_is_valid(
    const struct kernel_function_hook_context_pre *ctx
);

/*
    Validate sys_connect post-execution context.
    ...
    Returns:
        ...
        false   -> Invalid context.
*/
bool kernel_function_sys_connect_hook_context_post_is_valid(
    const struct kernel_function_hook_context_post *ctx
);

#endif // SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CONNECT_HOOK_H
