...
#ifndef SPADE_AUDIT_KERNEL_FUNCTION_SYS_CONNECT_HOOK_H
#define SPADE_AUDIT_KERNEL_FUNCTION_SYS_CONNECT_HOOK_H
...
#endif // SPADE_AUDIT_KERNEL_FUNCTION_SYS_CONNECT_HOOK_H
