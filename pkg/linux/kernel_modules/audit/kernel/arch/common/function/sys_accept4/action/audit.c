...
#include "audit/kernel/arch/common/function/sys_accept4/action/audit.h"
...
int kernel_arch_common_function_sys_accept4_action_audit_handle_post(
...
)
{
    ...
    if (!kernel_arch_common_function_sys_accept4_hook_context_post_is_valid(ctx_post))
        return -EINVAL;
