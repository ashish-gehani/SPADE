...
#define KERNEL_FUNCTION_SYS_ACCEPT4_BUILD_HOOK_CONTEXT(_fd, _addr, _addrlen, _flags) \
...
*/
bool kernel_arch_common_function_sys_accept4_hook_context_pre_is_valid(
...
/*
    ...
    Returns:
        ...
        false   -> Invalid context.
*/
bool kernel_arch_common_function_sys_accept4_hook_context_post_is_valid(
