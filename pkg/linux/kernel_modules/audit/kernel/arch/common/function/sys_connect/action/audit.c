...
#include "audit/kernel/arch/common/function/sys_connect/action/audit.h"
#include "audit/kernel/arch/common/function/sys_connect/arg.h"
#include "audit/kernel/arch/common/function/sys_connect/hook.h"
#include "audit/kernel/arch/common/function/sys_connect/result.h"
...
int kernel_arch_common_function_sys_connect_action_audit_handle_post(
    const struct kernel_function_hook_context_post *ctx_post
)
{
    const char *log_id = "kernel_arch_common_function_sys_connect_action_audit_handle_post";
    int err;
    ...
    struct kernel_function_sys_connect_arg *sys_arg;
    struct kernel_function_sys_connect_result *sys_res;

    if (!kernel_arch_common_function_sys_connect_hook_context_post_is_valid(ctx_post))
        return -EINVAL;
