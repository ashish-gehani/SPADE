...
#ifndef SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CLONE_HOOK_H
#define SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CLONE_HOOK_H
...
#endif // SPADE_AUDIT_KERNEL_ARCH_COMMON_FUNCTION_SYS_CLONE_HOOK_H
