...
#define KERNEL_FUNCTION_SYS_BIND_BUILD_HOOK_CONTEXT(_fd, _addr, _addrlen) \
...
*/
bool kernel_arch_common_function_sys_bind_hook_context_pre_is_valid(
    const struct kernel_function_hook_context_pre *ctx
);

/*
    Validate sys_bind post-execution context.
    ...
    Returns:
        ...
        false   -> Invalid context.
*/
bool kernel_arch_common_function_sys_bind_hook_context_post_is_valid(
