...
static void _ensure_initialized(void)
{
    ...
    {
        KERNEL_FUNCTION_SYS_CONNECT_OP.hook = kernel_arch_common_overridable_function_sys_connect_hook_get();
        KERNEL_FUNCTION_SYS_CONNECT_OP.action_list = kernel_arch_common_function_sys_connect_action_list_get();
