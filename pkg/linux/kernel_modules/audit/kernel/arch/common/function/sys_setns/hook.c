...
#include "audit/kernel/arch/common/function/sys_setns/result.h"
...
/* Arch-specific implementations (e.g. audit/kernel/arch/x86_64/function/sys_setns/hook.c) provide
...
const struct kernel_function_hook* __weak kernel_arch_common_overridable_function_sys_setns_hook_get(void)
{
    return NULL;
}

bool kernel_arch_common_function_sys_setns_hook_context_pre_is_valid(const struct kernel_function_hook_context_pre *ctx)
{
    return (
...
bool kernel_arch_common_function_sys_setns_hook_context_post_is_valid(const struct kernel_function_hook_context_post *ctx)
{
    return (
