...
enum kernel_function_number kernel_function_hook_function_accept_num(void)
{
    return global_func_num;
}

void kernel_function_sys_accept_hook_pre(const struct kernel_function_hook_context *h_ctx)
{
    int err;
...
void kernel_function_sys_accept_hook_post(const struct kernel_function_hook_context *h_ctx, long sys_res)
{
    int err;
...
const struct kernel_function_hook* __weak kernel_function_sys_accept_hook_get(void)
{
    return NULL;
}
