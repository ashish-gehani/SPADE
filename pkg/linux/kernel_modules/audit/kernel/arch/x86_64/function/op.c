...
int kernel_function_op_get_list(const struct kernel_function_op*** list, size_t *len)
{
    ...
    /* sys_accept's, sys_accept4's, sys_bind's, sys_clone's, and sys_connect's ops aren't
     * compile-time constants (their .hook is populated at runtime via their respective
