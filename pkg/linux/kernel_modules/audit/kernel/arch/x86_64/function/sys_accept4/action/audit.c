...
#include "audit/kernel/arch/x86_64/function/sys_accept4/arg.h"
#include "audit/kernel/arch/x86_64/function/sys_accept4/result.h"
#include "audit/kernel/arch/x86_64/function/sys_accept4/hook.h"
...
)
{
    ...
    if (!kernel_function_sys_accept4_hook_context_post_is_valid(ctx_post))
        return -EINVAL;
