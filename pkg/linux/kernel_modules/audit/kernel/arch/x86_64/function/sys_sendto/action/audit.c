...
#include "audit/kernel/arch/x86_64/function/sys_sendto/action/audit.h"
#include "audit/kernel/arch/x86_64/function/sys_sendto/arg.h"
#include "audit/kernel/arch/x86_64/function/sys_sendto/hook.h"
#include "audit/kernel/arch/x86_64/function/sys_sendto/result.h"
...
int kernel_function_sys_sendto_action_audit_handle_post(
    const struct kernel_function_hook_context_post *ctx_post
)
{
    const char *log_id = "kernel_function_sys_sendto_action_audit_handle_post";
    int err;
    ...
    if (!kernel_function_sys_sendto_hook_context_post_is_valid(ctx_post))
        return -EINVAL;
