...
#include "audit/kernel/arch/x86_64/function/sys_vfork/arg.h"
#include "audit/kernel/arch/x86_64/function/sys_vfork/hook.h"
#include "audit/kernel/arch/x86_64/function/sys_vfork/result.h"
...
static enum kernel_function_number kernel_function_hook_function_vfork_num(void)
{
...
const struct kernel_function_hook KERNEL_FUNCTION_SYS_VFORK_HOOK = {
