...
This build follows the general build guidelines of a package, except for the following variations.
...
`src` needs to be here so that packages are self-contained, and for easier development environment configuration.
