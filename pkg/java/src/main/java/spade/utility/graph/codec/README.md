...
Each package here is a separate codec for a graph - a self-contained way of encoding
...
- Create a package named after the codec, alongside `tokenize`.
...
- Add a README for the new package describing the codec, and link it above.
