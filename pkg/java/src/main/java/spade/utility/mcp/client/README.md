...
A standalone client that connects an LLM (Anthropic or a mock) to a running MCP server, useful for testing tools without a full MCP-compatible app like Claude Code/Desktop.
