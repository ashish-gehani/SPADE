...
#include "audit/kernel/function/sys_accept/arg.h"
#include "audit/kernel/function/sys_accept/hook.h"
#include "audit/kernel/function/sys_accept/result.h"
...
static enum kernel_function_number kernel_function_hook_function_accept_num(void)
{
...
const struct kernel_function_hook KERNEL_FUNCTION_SYS_ACCEPT_HOOK = {
    .get_num = kernel_function_hook_function_accept_num,
