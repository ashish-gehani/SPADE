 ...
 * Cache argument
 */
public abstract class CacheArgument{
	
	public final CacheName name;
	
	private ReportingArgument reportingArgument;
	
	protected CacheArgument(CacheName name){
		this.name = name;
	}
	...
	public boolean equals(Object obj){
		...
		if(getClass() != obj.getClass())
			return false;
		CacheArgument other = (CacheArgument)obj;
		if(name != other.name)
			return false;
	...
	public String toString(){
		return "CacheArgument [name=" + name + ", reportingArgument=" + reportingArgument + "]";
	}
}