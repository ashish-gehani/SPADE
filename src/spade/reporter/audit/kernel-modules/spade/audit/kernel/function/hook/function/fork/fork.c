...
static void _pre(void)
{
    ...
    struct kernel_function_arg_fork syscall_args = {};
...
static int kernel_function_hook_function_fork_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_fork = {
