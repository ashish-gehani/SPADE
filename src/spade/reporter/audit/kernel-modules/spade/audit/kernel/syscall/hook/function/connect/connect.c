...
static const char* global_sys_name = "sys_connect";

////

static void _pre(int fd, struct sockaddr __user *addr, uint32_t addrlen)
{
    int err;
...
static void _post(long sys_res, int fd, struct sockaddr __user *addr, uint32_t addrlen)
{
    int err;
