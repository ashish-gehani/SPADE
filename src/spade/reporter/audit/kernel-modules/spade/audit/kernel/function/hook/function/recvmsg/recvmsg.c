...
)
{
    ...
    struct kernel_function_arg_recvmsg syscall_args = {
        .sockfd = sockfd,
        .msg = msg,
        .flags = flags
    };
...
static int kernel_function_hook_function_recvmsg_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_recvmsg = {
