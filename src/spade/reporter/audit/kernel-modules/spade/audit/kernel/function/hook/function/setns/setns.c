...
static void _pre(void)
{
    ...
    struct kernel_function_arg_setns syscall_args = {};
...
static int kernel_function_hook_function_setns_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_setns = {
