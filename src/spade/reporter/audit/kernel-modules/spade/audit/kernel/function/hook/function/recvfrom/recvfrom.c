...
)
{
    ...
    struct kernel_function_arg_recvfrom syscall_args = {
        .sockfd = fd,
        .buf = buf,
        .len = len,
        .flags = flags,
...
static int kernel_function_hook_function_recvfrom_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_recvfrom = {
