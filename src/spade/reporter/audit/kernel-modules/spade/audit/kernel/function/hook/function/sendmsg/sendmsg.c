...
#include "spade/audit/kernel/function/arg/sendmsg.h"
...
)
{
    ...
    struct kernel_function_arg_sendmsg syscall_args = {
        .sockfd = sockfd,
        .msg = msg,
        .flags = flags
    };
...
static int kernel_function_hook_function_sendmsg_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_sendmsg = {
