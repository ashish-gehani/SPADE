...
)
{
    ...
    struct kernel_function_arg_bind syscall_args = {
        .sockfd = fd,
        .addr = addr,
        .addrlen = addrlen
    };
...
static int kernel_function_hook_function_bind_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_bind = {
