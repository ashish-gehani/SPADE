...
static void _pre(void)
{
    ...
    struct kernel_function_arg_vfork syscall_args = {};
...
static int kernel_function_hook_function_vfork_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_vfork = {
