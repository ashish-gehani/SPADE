...
static void _pre(unsigned long flags)
{
    ...
    struct kernel_function_arg_clone syscall_args = {};
...
static int kernel_function_hook_function_clone_num(void)
{
...
const struct kernel_function_hook kernel_function_hook_clone = {
