...
static void __maybe_unused state_namespace_write_to_seqbuf_redacted(
    struct seqbuf *b, const struct state_namespace *state
)
{
...
static void __maybe_unused state_namespace_write_to_seqbuf_unredacted(
    struct seqbuf *b, const struct state_namespace *state
)
{
    struct kernel_namespace_pointers *k_ptrs;
...
#ifdef DEBUG
    state_namespace_write_to_seqbuf_unredacted(b, state);
#else
    state_namespace_write_to_seqbuf_redacted(b, state);
#endif
}

void state_namespace_print(const struct state_namespace *state)
{
    const char *func_name = "state_namespace_print";
    ...
    state_namespace_write_to_seqbuf(&sb, state);
