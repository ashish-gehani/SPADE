...
#ifndef SPADE_AUDIT_STATE_FUNCTION_PRINT_H
#define SPADE_AUDIT_STATE_FUNCTION_PRINT_H
...
/*
    Write the state struct to a seqbuf.
...
#endif // SPADE_AUDIT_STATE_FUNCTION_PRINT_H
