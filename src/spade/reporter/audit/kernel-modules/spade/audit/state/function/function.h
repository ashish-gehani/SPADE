...
#ifndef SPADE_AUDIT_STATE_FUNCTION_FUNCTION_H
#define SPADE_AUDIT_STATE_FUNCTION_FUNCTION_H
...
/*
    Check if the function related state is initialized.
...
/*
    ...
    Returns:
        ...
        -ive    -> Error code.
*/
int state_function_deinit(
    struct state_function *s
);

#endif // SPADE_AUDIT_STATE_FUNCTION_FUNCTION_H