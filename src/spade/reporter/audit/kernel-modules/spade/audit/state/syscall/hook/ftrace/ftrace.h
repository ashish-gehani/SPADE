...
#ifndef SPADE_AUDIT_STATE_SYSCALL_HOOK_FTRACE_H
#define SPADE_AUDIT_STATE_SYSCALL_HOOK_FTRACE_H
...
/*
    Check if the syscall ftrace state is initialized.
...
#endif // SPADE_AUDIT_STATE_SYSCALL_HOOK_FTRACE_H