...
#ifndef _SPADE_AUDIT_HELPER_TASK_H
#define _SPADE_AUDIT_HELPER_TASK_H
...
/*
    ...
    Returns:
        uid -> Always
*/
uid_t helper_task_host_view_current_uid(void);
...
/*
    ...
    Returns:
        euid -> Always
*/
uid_t helper_task_host_view_current_euid(void);
...
/*
    ...
    Returns:
        suid -> Always
*/
uid_t helper_task_host_view_current_suid(void);
...
/*
    ...
    Returns:
        fsuid -> Always
*/
uid_t helper_task_host_view_current_fsuid(void);
...
/*
    ...
    Returns:
        gid -> Always
*/
gid_t helper_task_host_view_current_gid(void);
...
/*
    ...
    Returns:
        egid -> Always
*/
gid_t helper_task_host_view_current_egid(void);
...
/*
    ...
    Returns:
        sgid -> Always
*/
gid_t helper_task_host_view_current_sgid(void);
...
/*
    ...
    Returns:
        fsgid -> Always
*/
gid_t helper_task_host_view_current_fsgid(void);
...
/*
    ...
    Returns:
        ppid -> Always
*/
pid_t helper_task_task_view_current_ppid(void);
...
/*
    ...
    Returns:
        pid -> Always
*/
pid_t helper_task_task_view_current_pid(void);
...
/*
    ...
    Returns:
        ...
        NULL                 -> Otherwise.
*/
struct audit_context* helper_task_current_audit_context(void);
...
#endif // _SPADE_AUDIT_HELPER_TASK_H