/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.core.provenance.manager;
...
public final class Manager<C extends spade.reporter.audit.core.provenance.Context>{
	...
	public List<ProvenanceElement> handle(final C provContext) throws InterruptedException, ReadTimeoutExpired, WriteTimeoutExpired {
		...
		final List<ProvenanceElement> elements = Collections.unmodifiableList(event.handle(provContext));
