...
public abstract class Timestamp implements Indexable<Timestamp>{

	private final String valueStr;

	protected Timestamp(final String valueStr){
		if(valueStr == null){
	...
	public boolean equals(final Object obj){
		...
		return this.valueStr.equals(((Timestamp) obj).valueStr);
	}
	...
	public final String toString(){
		return "Timestamp[valueStr=" + valueStr + "]";
	}
