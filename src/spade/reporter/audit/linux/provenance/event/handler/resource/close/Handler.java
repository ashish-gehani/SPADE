/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.provenance.event.handler.resource.close;
...
import spade.reporter.audit.linux.provenance.event.type.resource.close.Event;
