...
public class ProcessUpdate implements spade.reporter.audit.core.provenance.event.handler.Handler<spade.reporter.audit.linux.provenance.event.ProcessUpdate, Context>{

	@Override
	public List<ProvenanceElement> handle(final spade.reporter.audit.linux.provenance.event.ProcessUpdate event, final Context provContext){
		final PlatformProcess provOldVersion = event.getOldVersion();
		final PlatformProcess provNewVersion = event.getNewVersion();
