...
public class ProcessCreateSynthetic implements spade.reporter.audit.core.provenance.event.handler.Handler<spade.reporter.audit.linux.provenance.event.ProcessCreateSynthetic, Context>{

	@Override
	public List<ProvenanceElement> handle(final spade.reporter.audit.linux.provenance.event.ProcessCreateSynthetic event, final Context provContext){
