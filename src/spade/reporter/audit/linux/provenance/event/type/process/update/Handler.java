/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.provenance.event.type.process.update;
...
public class Handler implements spade.reporter.audit.core.provenance.event.Handler<Event, HandlerContext>{

	@Override
	public void handle(final Event event, final HandlerContext provContext){
		final ProvProcess provOldVersion = event.getOldVersion();
		final ProvProcess provNewVersion = event.getNewVersion();
