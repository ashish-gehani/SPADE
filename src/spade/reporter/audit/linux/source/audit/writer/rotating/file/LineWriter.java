/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.source.audit.writer.rotating.file;
...
public class LineWriter extends spade.reporter.audit.linux.source.audit.writer.LineWriter {
    ...
    public LineWriter(
        ...
        this.currentWriter = new spade.reporter.audit.linux.source.audit.writer.file.LineWriter(currentFilePath());
    }
    ...
    private void rotate() throws Exception {
        ...
        currentFileIndex++;
        totalBytesWritten = 0;
        currentWriter = new spade.reporter.audit.linux.source.audit.writer.file.LineWriter(currentFilePath());
    }
