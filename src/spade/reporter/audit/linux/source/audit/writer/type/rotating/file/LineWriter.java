/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.source.audit.writer.type.rotating.file;
...
public class LineWriter extends spade.reporter.audit.linux.source.audit.writer.LineWriter {
    ...
    private spade.reporter.audit.linux.source.audit.writer.LineWriter currentWriter;
    ...
    public LineWriter(
        ...
        this.currentWriter = new spade.reporter.audit.linux.source.audit.writer.type.file.LineWriter(currentFilePath());
    }
    ...
    private void rotate() throws Exception {
        ...
        currentFileIndex++;
        totalBytesWritten = 0;
        currentWriter = new spade.reporter.audit.linux.source.audit.writer.type.file.LineWriter(currentFilePath());
    }
