 ...
 *
 * Pipeline: {@link spade.reporter.audit.linux.source.audit.reader.EventReader}
...
public class Helper {
    ...
    public Tee createTee(final Config config) throws Exception {
        ...
        final EventReader reader =
            new spade.reporter.audit.linux.source.audit.reader.Helper().createEventReader(
                config.getReaderConfig()
            );
        final EventWriter writer =
            new spade.reporter.audit.linux.source.audit.writer.Helper().createWriter(
