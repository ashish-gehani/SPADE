...
public class Event extends spade.reporter.audit.linux.source.audit.event.Event{
	...
	private final spade.reporter.audit.linux.source.audit.event.record.type.Netfilter record;

	protected Event(
		final spade.reporter.audit.linux.source.audit.event.record.type.Netfilter record
	){
	...
	public spade.reporter.audit.linux.source.audit.event.record.type.Netfilter getNetfilterRecord(){
		return record;
	}
}
