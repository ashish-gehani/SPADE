...
public class SystemVSharedMemory extends Descriptor{

	private final SystemV systemV;

	public SystemVSharedMemory(final Num num, final SystemV systemV){
		super(Type.SYSV_SHARED_MEMORY, num);
		if(systemV == null){
			throw new IllegalArgumentException("systemV cannot be NULL");
		}
