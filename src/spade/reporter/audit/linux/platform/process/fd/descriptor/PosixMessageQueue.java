...
public class PosixMessageQueue extends Path{
	...
	public PosixMessageQueue(final Num num, final DirEnt dirEnt){
		super(Type.POSIX_MESSAGE_QUEUE, num, spade.reporter.audit.linux.platform.resource.dirent.Type.POSIX_MESSAGE_QUEUE, dirEnt);
	}
