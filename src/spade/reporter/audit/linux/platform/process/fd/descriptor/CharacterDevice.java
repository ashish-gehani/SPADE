...
public class CharacterDevice extends Path{
	...
	public CharacterDevice(final Num num, final DirEnt dirEnt){
		super(Type.CHARACTER_DEVICE, num, spade.reporter.audit.linux.platform.resource.dirent.Type.CHARACTER_DEVICE, dirEnt);
	}
