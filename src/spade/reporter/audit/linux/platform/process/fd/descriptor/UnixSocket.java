...
public class UnixSocket extends Path{
	...
	public UnixSocket(final Num num, final DirEnt dirEnt){
		super(Type.UNIX_SOCKET, num, spade.reporter.audit.linux.platform.resource.dirent.Type.UNIX_SOCKET, dirEnt);
	}
