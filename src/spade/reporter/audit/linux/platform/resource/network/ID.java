...
import spade.reporter.audit.linux.platform.type.network.ip.V4;
import spade.reporter.audit.linux.platform.type.network.ip.V6;
...
public class ID extends spade.reporter.audit.linux.platform.resource.ID{
	...
	private spade.reporter.audit.linux.platform.type.namespace.ID netns(){
	...
	private static int compareNetns(
		final spade.reporter.audit.linux.platform.type.namespace.ID a,
		final spade.reporter.audit.linux.platform.type.namespace.ID b
	){
