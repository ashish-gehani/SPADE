...
public class VersionedID extends spade.reporter.audit.linux.platform.resource.VersionedID{
	...
	public VersionedID(final VersionedID other){
		this(new MessageQueue(other.getMessageQueue()), new ID(other.ipcNamespace), other.getVersion());
	}

	public MessageQueue getMessageQueue(){
		return (MessageQueue) getResource();
	}
	...
	private String id(){
		return getMessageQueue().getId();
	}

	private long ownerUID(){
		return getMessageQueue().getOwnerUID().getValue();
	}

	private long ownerGID(){
		return getMessageQueue().getOwnerGID().getValue();
	}
	...
	public boolean equals(final Object obj){
		...
		return this.getMessageQueue().equals(other.getMessageQueue())
	...
	@Override
	public int hashCode(){
		int result = getMessageQueue().hashCode();
