...
public class ID extends spade.reporter.audit.linux.platform.resource.ID{
	...
	private spade.reporter.audit.linux.type.namespace.ID ipcNamespace(){
	...
	public int compareTo(final spade.reporter.audit.linux.platform.resource.ID other){
		...
		if(c != 0) return c;
		spade.reporter.audit.linux.type.namespace.ID thisIpc = this.ipcNamespace();
		spade.reporter.audit.linux.type.namespace.ID otherIpc = o.ipcNamespace();
