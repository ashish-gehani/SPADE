/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.audit.output.writer.rotating.file;
...
/**
 * A {@link spade.reporter.audit.linux.audit.output.writer.LineWriter} that
 ...
 */
public class LineWriter extends spade.reporter.audit.linux.audit.output.writer.LineWriter {
    ...
    private spade.reporter.audit.linux.audit.output.writer.file.LineWriter currentWriter;
    ...
    public LineWriter(
        ...
        this.currentWriter = new spade.reporter.audit.linux.audit.output.writer.file.LineWriter(currentFilePath());
    }
    ...
    private void rotate() throws Exception {
        ...
        currentFileIndex++;
        totalBytesWritten = 0;
        currentWriter = new spade.reporter.audit.linux.audit.output.writer.file.LineWriter(currentFilePath());
    }
