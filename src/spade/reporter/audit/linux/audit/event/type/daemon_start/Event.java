...
public class Event extends spade.reporter.audit.linux.audit.event.Event{
	...
	private final spade.reporter.audit.linux.audit.event.record.type.DaemonStart record;
	...
	public spade.reporter.audit.linux.audit.event.record.type.DaemonStart getDaemonStartRecord(){
		return record;
	}
