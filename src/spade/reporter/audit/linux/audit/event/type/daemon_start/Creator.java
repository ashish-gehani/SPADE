/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.audit.event.type.daemon_start;
...
public class Creator extends spade.reporter.audit.linux.audit.event.Creator{
	...
	protected String validate(final List<Record> records){
		...
		if(!(r instanceof spade.reporter.audit.linux.audit.event.record.type.DaemonStart)){
	...
	protected spade.reporter.audit.linux.audit.event.Event create(
		...
		final spade.reporter.audit.linux.audit.event.record.type.DaemonStart record = (
			(spade.reporter.audit.linux.audit.event.record.type.DaemonStart) records.get(0)
		);
