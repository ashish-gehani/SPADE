...
public class Event extends spade.reporter.audit.linux.audit.event.Event{
	...
	private final spade.reporter.audit.linux.audit.event.record.type.ubsi.UbsiRaw record;

	protected Event(
		final spade.reporter.audit.linux.audit.event.record.type.ubsi.UbsiRaw record
	){
	...
	public spade.reporter.audit.linux.audit.event.record.type.ubsi.UbsiRaw getUBSIRawRecord(){
		return record;
	}
