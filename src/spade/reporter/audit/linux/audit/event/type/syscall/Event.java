...
public class Event extends spade.reporter.audit.linux.audit.event.Event{
	...
	private final spade.reporter.audit.linux.audit.event.record.type.Syscall syscallRecord;

	protected Event(
		final spade.reporter.audit.linux.audit.event.record.type.Syscall syscallRecord,
	...
	public spade.reporter.audit.linux.audit.event.record.type.Syscall getSyscallRecord(){
