...
public class UbsiExit extends Event{
	...
	public spade.reporter.audit.linux.audit.event.record.ubsi.UbsiExit getUbsiExitRecord(){
		return record;
	}
	...
	protected static class Creator extends Event.Creator{
		...
		protected Event create(final List<Record> records) throws MalformedEventException{
			...
			return new UbsiExit(
				(spade.reporter.audit.linux.audit.event.record.ubsi.UbsiExit) records.get(0));
		}
	}
}
