/*
 ...
 --------------------------------------------------------------------------------
 */
package spade.reporter.audit.linux.audit.event.writer.type.rotating.file;

import java.util.logging.Level;
import java.util.logging.Logger;

import spade.reporter.audit.linux.audit.event.writer.Type;
 ...
 */
public class LineWriter extends spade.reporter.audit.linux.audit.event.writer.LineWriter {
    ...
    private spade.reporter.audit.linux.audit.event.writer.LineWriter currentWriter;
    ...
    public LineWriter(
        ...
        this.currentWriter = new spade.reporter.audit.linux.audit.event.writer.type.file.LineWriter(currentFilePath());
    }
    ...
    private void rotate() throws Exception {
        ...
        currentFileIndex++;
        totalBytesWritten = 0;
        currentWriter = new spade.reporter.audit.linux.audit.event.writer.type.file.LineWriter(currentFilePath());
    }
