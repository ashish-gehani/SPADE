 ...
 *
 * Pipeline: {@link spade.reporter.audit.linux.audit.event.reader.LineReader} →
...
public class Helper {
    ...
    public BufferedEventReader createReader(final Config config) throws Exception {
        ...
        final spade.reporter.audit.linux.audit.event.reader.LineReader lineReader =
            new spade.reporter.audit.linux.audit.event.reader.Factory().create(
