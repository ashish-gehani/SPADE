...
public class Config {
	...
	private final spade.reporter.audit.core.util.channel.Config channelConfig;
	...
	protected Config(
			...
			final spade.reporter.audit.core.util.channel.Config channelConfig,
	...
	public spade.reporter.audit.core.util.channel.Config getChannelConfig() {
