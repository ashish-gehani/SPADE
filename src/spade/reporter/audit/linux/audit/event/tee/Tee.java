 ...
 */
public final class Tee extends Reader<ID, HandlerContext, Event>{
    ...
    public spade.reporter.audit.linux.audit.event.reader.Metrics getReaderMetrics() {
        return reader.getMetrics();
    }

    public spade.reporter.audit.linux.audit.event.writer.Metrics getWriterMetrics() {
