...
public class UbsiDep extends Event{
	...
	public spade.reporter.audit.linux.audit.event.record.ubsi.UbsiDep getUbsiDepRecord(){
		return record;
	}
	...
	protected static class Creator extends Event.Creator{
		...
		protected Event create(final List<Record> records) throws MalformedEventException{
			...
			return new UbsiDep(
				(spade.reporter.audit.linux.audit.event.record.ubsi.UbsiDep) records.get(0));
		}
	}
}
