...
public class EventReader implements AutoCloseable{
	...
	private final List<String> optionalColumns = new ArrayList<String>(
			Arrays.asList(
					COLUMN_DATE_AND_TIME
					, COLUMN_TID
					)
			);
	...
	public EventReader(final String filePath) throws Exception{
		try{
			reader = new BufferedReader(new FileReader(filePath));
			final String[] headerValues = parseCSVLine();
	...
	public Event read() throws Exception{
		final String[] tokens = parseCSVLine();
		if(tokens == null){
			return null;
		}
	...
	private String[] parseCSVLine() throws Exception{
