...
public abstract class TreeStringSerializable
{
    ...
    {
        ArrayList<String> inline_field_names = new ArrayList<>();
        ArrayList<String> inline_field_values = new ArrayList<>();
        ArrayList<String> non_container_child_field_names = new ArrayList<>();
        ArrayList<TreeStringSerializable> non_container_child_fields = new ArrayList<>();
        ArrayList<String> container_child_field_names = new ArrayList<>();
        ArrayList<ArrayList<? extends TreeStringSerializable>> container_child_fields = new ArrayList<>();
        ...
        if(!non_container_child_fields.isEmpty())
        {
            ...
            {
                TreeStringSerializable node = non_container_child_fields.get(last_index);
                if(node == null)
                {
                    node = null_node;
                }
