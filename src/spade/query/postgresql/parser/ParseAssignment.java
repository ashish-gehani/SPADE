...
public class ParseAssignment extends ParseStatement
{
    ...
    public static AssignmentType ResolveAssignmentType(String input)
    {
        ...
        {
            case "=":
                return AssignmentType.kEqual;
            case "+=":
                return AssignmentType.kPlusEqual;
            case "-=":
                return AssignmentType.kMinusEqual;
            case "&=":
                return AssignmentType.kIntersectEqual;
            default:
                break;
        }
        return null;
    ...
    public ParseAssignment(int lineNumber, int columnNumber,
                           ...
                           ParseExpression rhs)
    {
        super(lineNumber, columnNumber, StatementType.kAssignment);
