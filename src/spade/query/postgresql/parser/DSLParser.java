...
import spade.query.postgresql.types.*;
...
public class DSLParser extends Parser
{
    ...
    public static class ProgramContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_SEMICOLON);
        }
    ...
    public static class StatementContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_ASSIGN, 0);
        }

        public TerminalNode TOKEN_PLUS_ASSIGN()
        {
            return getToken(DSLParser.TOKEN_PLUS_ASSIGN, 0);
        }

        public TerminalNode TOKEN_MINUS_ASSIGN()
        {
            return getToken(DSLParser.TOKEN_MINUS_ASSIGN, 0);
        }

        public TerminalNode TOKEN_INTERSECT_ASSIGN()
        {
            return getToken(DSLParser.TOKEN_INTERSECT_ASSIGN, 0);
        }
    ...
    public static class Or_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_OR);
        }
    ...
    public static class And_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_AND);
        }
    ...
    public static class Not_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_NOT, 0);
        }
    ...
    public static class Comparison_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_LIKE, 0);
        }

        public TerminalNode TOKEN_EQUAL()
        {
            return getToken(DSLParser.TOKEN_EQUAL, 0);
        }
        ...
        {
            return getToken(DSLParser.TOKEN_NOT_EQUAL, 0);
        }

        public TerminalNode TOKEN_REGEX()
        {
            return getToken(DSLParser.TOKEN_REGEX, 0);
        }

        public TerminalNode TOKEN_LESS()
        {
            return getToken(DSLParser.TOKEN_LESS, 0);
        }

        public TerminalNode TOKEN_GREATER()
        {
            return getToken(DSLParser.TOKEN_GREATER, 0);
        }

        public TerminalNode TOKEN_LESS_EQUAL()
        {
            return getToken(DSLParser.TOKEN_LESS_EQUAL, 0);
        }

        public TerminalNode TOKEN_GREATER_EQUAL()
        {
            return getToken(DSLParser.TOKEN_GREATER_EQUAL, 0);
        }
    ...
    public static class Add_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_PLUS);
        }
        ...
        {
            return getTokens(DSLParser.TOKEN_MINUS);
        }
    ...
    public static class Intersect_expressionContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_INTERSECT);
        }
        ...
        public int getRuleIndex()
        {
            return RULE_intersect_expression;
        }
    }
    ...
    public static class Function_callContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_LPAREN);
        }
        ...
        {
            return getTokens(DSLParser.TOKEN_RPAREN);
        }
        ...
        {
            return getTokens(DSLParser.TOKEN_DOT);
        }
    ...
    public static class FactorContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_LPAREN, 0);
        }
        ...
        {
            return getToken(DSLParser.TOKEN_RPAREN, 0);
        }
    ...
    public static class Argument_listContext extends ParserRuleContext
    {
        ...
        {
            return getTokens(DSLParser.TOKEN_COMMA);
        }
    ...
    public static class NameContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_NAME, 0);
        }

        public TerminalNode TOKEN_DOUBLE_QUOTED_NAME()
        {
            return getToken(DSLParser.TOKEN_DOUBLE_QUOTED_NAME, 0);
        }
    ...
    public static class VariableContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_GRAPH_VARIABLE, 0);
        }

        public TerminalNode TOKEN_GRAPH_METADATA_VARIABLE()
        {
            return getToken(DSLParser.TOKEN_GRAPH_METADATA_VARIABLE, 0);
        }
    ...
    public static class LiteralContext extends ParserRuleContext
    {
        ...
        {
            return getToken(DSLParser.TOKEN_NUMBER, 0);
        }

        public TerminalNode TOKEN_SINGLE_QUOTED_STRING_LITERAL()
        {
            return getToken(DSLParser.TOKEN_SINGLE_QUOTED_STRING_LITERAL, 0);
        }
