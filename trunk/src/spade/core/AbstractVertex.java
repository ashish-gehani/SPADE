...
public abstract class AbstractVertex {
    ...
    public String toString() {
        String vertexString = "";
        for (Iterator iter = annotations.keySet().iterator(); iter.hasNext();) {
    ...
    @Override
    public int hashCode() {
        final int hashInt = 67;
        int hashCode = 3;
        hashCode = hashInt * hashCode + (this.vertexType != null ? this.vertexType.hashCode() : 0);
