...
public class Kernel {
                ...
                try {
                    while (true) {
                        ...
                        if (!removestorages.isEmpty()) {
                            Iterator iter = removestorages.iterator();
                            AbstractStorage storage = (AbstractStorage) iter.next();
                            storage.shutdown();
    ...
    public static void listCommand(String line) {
        ...
        try {
            if (tokens[1].equalsIgnoreCase("producer")) {
                ...
                Iterator iter = storages.iterator();
                int count = 1;
                while (iter.hasNext()) {
                    System.out.println(count + ") " + iter.next().getClass().getName().split("\\.")[2]);
                    count++;
                ...
                while (iter.hasNext()) {
                    ...
                    if (storage.getClass().getName().equals("spade.storage." + tokens[2])) {
                        ...
                        while (removestorages.contains(storage)) {
                            // wait for other thread to remove storage
                        }
                        System.out.println("done");
                    }
                }
    ...
    public static void putVertex(Vertex v) {
        Iterator iter = storages.iterator();
        while (iter.hasNext()) {
            ((AbstractStorage) iter.next()).putVertex(v);
        }
    }
    ...
    public static void putEdge(Edge e) {
        Iterator iter = storages.iterator();
        while (iter.hasNext()) {
            ((AbstractStorage) iter.next()).putEdge(e);
        }
    }
...
class FinalCommitFilter extends AbstractFilter {
    ...
    public void putEdge(Edge e) {
        ...
        while (it.hasNext()) {
            ((AbstractStorage) it.next()).putEdge(e);
        }
    }
}
