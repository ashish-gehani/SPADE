...
import spade.Lineage;
import spade.QueryInterface;
                ...
                for (Relationship r : tempNode.getRelationships(dir)) {
                    ...
                    if (direction == 0) {
                        if (rtype.equals("Used")) {
                            Edge tempEdge = new Used((Process) VertexTable.get(tempNode.getId()), (Artifact) VertexTable.get(otherNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasGeneratedBy")) {
                            Edge tempEdge = new WasGeneratedBy((Artifact) VertexTable.get(tempNode.getId()), (Process) VertexTable.get(otherNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasTriggeredBy")) {
                            Edge tempEdge = new WasTriggeredBy((Process) VertexTable.get(tempNode.getId()), (Process) VertexTable.get(otherNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasDerivedFrom")) {
                            Edge tempEdge = new WasDerivedFrom((Artifact) VertexTable.get(tempNode.getId()), (Artifact) VertexTable.get(otherNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasControlledBy")) {
                            Edge tempEdge = new WasControlledBy((Process) VertexTable.get(tempNode.getId()), (Agent) VertexTable.get(otherNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        }
                    } else {
                        if (rtype.equals("Used")) {
                            Edge tempEdge = new Used((Process) VertexTable.get(otherNode.getId()), (Artifact) VertexTable.get(tempNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasGeneratedBy")) {
                            Edge tempEdge = new WasGeneratedBy((Artifact) VertexTable.get(otherNode.getId()), (Process) VertexTable.get(tempNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasTriggeredBy")) {
                            Edge tempEdge = new WasTriggeredBy((Process) VertexTable.get(otherNode.getId()), (Process) VertexTable.get(tempNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasDerivedFrom")) {
                            Edge tempEdge = new WasDerivedFrom((Artifact) VertexTable.get(otherNode.getId()), (Artifact) VertexTable.get(tempNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        } else if (rtype.equals("WasControlledBy")) {
                            Edge tempEdge = new WasControlledBy((Process) VertexTable.get(otherNode.getId()), (Agent) VertexTable.get(tempNode.getId()));
                            convertRelationshipToEdge(r, tempEdge);
                            lineage.putEdge(tempEdge);
                        }
                    }
